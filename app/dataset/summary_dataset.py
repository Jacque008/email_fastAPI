...
class SummaryDataset:
    ...
    def generate_summary(self, request: SummaryIn, use_case: str = 'api') -> SummaryOut:
        """
        ...
        Returns:
            SummaryOut object with appropriate summary fields populated
        """
        try:
            ...
            return SummaryOut(error_message=f"Summary generation failed: {str(e)}")
    
    def _generate_detailed_summaries(self, chat_df: pd.DataFrame, 
                                   email_df: pd.DataFrame, 
                                   comment_df: pd.DataFrame) -> SummaryOut:
    ...
    def _process_chat_summaries(self, chat_df: pd.DataFrame, result: SummaryOut) -> SummaryOut:
    ...
    def _process_email_summary(self, email_df: pd.DataFrame, result: SummaryOut) -> SummaryOut:
    ...
    def _process_comment_summaries(self, comment_df: pd.DataFrame, result: SummaryOut) -> SummaryOut:
