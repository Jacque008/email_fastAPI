...
class CreateForwarding(PreProcess):
    def __init__(self):
        ...
        self.forwardSummaryInfoQuery = self.queries['forwardSummaryInfo'].iloc[0] # keep for paymentMatching and app.py 
    ...
    def main(self, df): 
        ...
        summary = fetchFromDB(self.forwardSummaryInfoQuery.format(ID=df['id'].iloc[0]))
